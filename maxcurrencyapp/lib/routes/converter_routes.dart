...
import 'package:maxcurrencyapp/screens/widgets/home_page.dart';
...
switch (settings.name){
  ...
  return MaterialPageRoute(builder: (context) =>  HomePage(currencyData: settings.arguments as List<CurrencyModel>));
  default:
  return MaterialPageRoute(builder: (context)=> const SplashPage());
}
  }
